...
import no.nav.helse.hops.hops.ResourceLoader
import no.nav.helse.hops.hops.fhir.toJson
import no.nav.helse.hops.hops.models.HjelpemiddelRequest
import no.nav.helse.hops.hops.models.digihot.DigihotKvittering
import no.nav.helse.hops.hops.testdata.createCommunicationAboutDeviceRequsts
import no.nav.helse.hops.hops.testdata.createCommunicationBundle
import no.nav.helse.hops.hops.testdata.createDeviceRequest
