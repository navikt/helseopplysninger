...
data class JAASCredentialCustom(val username: String, val password: String)

internal val kafkaAdmin = JAASCredentialCustom("srvkafkabroker", "kafkabroker")
internal val kafkaClient = JAASCredentialCustom("srvkafkaclient", "kafkaclient")
internal val kafkaC1 = JAASCredentialCustom("srvkafkac1", "kafkac1")
internal val kafkaP1 = JAASCredentialCustom("srvkafkap1", "kafkap1")
internal val kafkaC2 = JAASCredentialCustom("srvkafkac2", "kafkac2")
internal val kafkaP2 = JAASCredentialCustom("srvkafkap2", "kafkap2")
...
object JAASCustomUsers {
    ...
    fun addUsers(u: List<JAASCredentialCustom>) {
